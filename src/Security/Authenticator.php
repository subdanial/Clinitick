...
class Authenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $user = $this->entityManager->getRepository(Assistants::class)->findOneBy(['mobile' => $credentials['mobile']]);

        if (!$user instanceof Assistants) {
            $this->session->getFlashBag()->add('danger', 'کاربری با این نام‌ کاربری ثبت نشده است.');
//            throw new \Exception('کاربری با این نام‌کاربری ثبت نشده است.');
        }
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('dashboard.home.index'));
    }
